...
CxxTest::StaticSuiteDescription suiteDescription_LanguageTests( "./tests/LanguageTests.h", 22, "LanguageTests", suite_LanguageTests, Tests_LanguageTests );

static class TestDescription_suite_LanguageTests_testVariableAssignment : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_LanguageTests_testVariableAssignment() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 32, "testVariableAssignment" ) {}
...
public:
 TestDescription_suite_LanguageTests_testStringConcatenation() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 41, "testStringConcatenation" ) {}
...
public:
 TestDescription_suite_LanguageTests_testAddition() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 51, "testAddition" ) {}
...
public:
 TestDescription_suite_LanguageTests_testFunctions() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 60, "testFunctions" ) {}
...
public:
 TestDescription_suite_LanguageTests_testArguments() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 69, "testArguments" ) {}
...
public:
 TestDescription_suite_LanguageTests_testObjectInstantiation() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 78, "testObjectInstantiation" ) {}
...
public:
 TestDescription_suite_LanguageTests_testBasicLogic() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 87, "testBasicLogic" ) {}
...
public:
 TestDescription_suite_LanguageTests_testBasicLogicWithExpressions() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 96, "testBasicLogicWithExpressions" ) {}
...
public:
 TestDescription_suite_LanguageTests_testNotLogic() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 105, "testNotLogic" ) {}
...
public:
 TestDescription_suite_LanguageTests_testCallbacks() : CxxTest::RealTestDescription( Tests_LanguageTests, suiteDescription_LanguageTests, 114, "testCallbacks" ) {}
